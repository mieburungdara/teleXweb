...
|
*/
$config['base_url'] = 'https://core.my.id/web/';
...
$config['monolog_handlers'] = [
    [
        ...
        'args' => [
            APPPATH . 'logs/monolog.log', // Log file path
            \Monolog\Logger::DEBUG        // Minimum log level to handle
        ],
    ],
];
...
$config['sess_save_path'] = 'ci_sessions'; // nama tabel session
...
$config['csrf_exclude_uris'] = array('miniapp/auth');
